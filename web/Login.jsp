        ...
        <div class="container">
            ...
            <div class="row" >
                ...
                <div class="col-md-5" id="logreg-forms" style="background-image: linear-gradient(to bottom right, #c165dd, #268bff); margin: 0px; -webkit-box-shadow: 0 30px 60px 0 rgba(0,0,0,0.3); opacity: 100%">
                    <form action="login" class="form-signin" id="login-form" name="login-form"  method="post">
                        <br><br><br><br>
                        ...
                        <input style="margin-bottom: 8px; border-radius: 8px" name="pass" value="${password}" type="password" id="pass" class="form-control" placeholder="Password" required="">
